 ...
 */
function acf_rental_block_init() {
	register_block_type( __DIR__ . '/blocks' );
}
add_action( 'init', 'acf_rental_block_init' );

/**
 * Registers the ACF fields using PHP APIs.
 */
function acf_rental_register_php_fields() {
	if ( function_exists( 'acf_add_local_field_group' ) ) :

		acf_add_local_field_group(
			array(
				'key'                   => 'group_6m23487a0sfm24398',
				'title'                 => ' Example Field',
				'fields'                => array(
					array(
						'key'               => 'field_633fe298f7b2e',
						'label'             => 'Example Text Field',
						'name'              => 'acf_rental_text_field',
						'type'              => 'text',
						'instructions'      => '',
						'required'          => 0,
						'conditional_logic' => 0,
...
add_action( 'acf/include_fields', 'acf_rental_register_php_fields' );
